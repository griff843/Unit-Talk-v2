...
| **Command Center product intent** | `docs/03_product/command-center/intent.md` |
...
| Command Center (operator control surface) | `docs/03_product/command-center/intent.md` |
