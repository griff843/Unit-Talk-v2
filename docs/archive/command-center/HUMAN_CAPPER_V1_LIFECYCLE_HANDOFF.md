> **ARCHIVED — historical measurement only.** This dated handoff is preserved for decision history and must not be used as current Command Center or Human Capper product authority. Current Command Center product authority: `docs/03_product/COMMAND_CENTER_PRODUCT_CONTRACT.md`. Current runtime truth must be re-measured.
