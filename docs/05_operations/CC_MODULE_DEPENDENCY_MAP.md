# CC_MODULE_DEPENDENCY_MAP — ARCHIVED
...
[`docs/archive/command-center/CC_MODULE_DEPENDENCY_MAP.md`](../../docs/archive/command-center/CC_MODULE_DEPENDENCY_MAP.md). Read it to understand why a
