# CC_PLAYER_RESEARCH_DATA_MODEL — ARCHIVED
...
[`docs/archive/command-center/CC_PLAYER_RESEARCH_DATA_MODEL.md`](../../docs/archive/command-center/CC_PLAYER_RESEARCH_DATA_MODEL.md). Read it to understand why a
