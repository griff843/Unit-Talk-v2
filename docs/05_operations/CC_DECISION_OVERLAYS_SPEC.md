# CC_DECISION_OVERLAYS_SPEC — ARCHIVED
...
[`docs/archive/command-center/CC_DECISION_OVERLAYS_SPEC.md`](../../docs/archive/command-center/CC_DECISION_OVERLAYS_SPEC.md). Read it to understand why a
