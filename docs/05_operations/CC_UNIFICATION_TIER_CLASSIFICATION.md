# CC_UNIFICATION_TIER_CLASSIFICATION — ARCHIVED
...
[`docs/archive/command-center/CC_UNIFICATION_TIER_CLASSIFICATION.md`](../../docs/archive/command-center/CC_UNIFICATION_TIER_CLASSIFICATION.md). Read it to understand why a
