# T1_COMMAND_CENTER_BURNIN_TRUTH_CONTRACT — ARCHIVED
...
[`docs/archive/command-center/T1_COMMAND_CENTER_BURNIN_TRUTH_CONTRACT.md`](../../docs/archive/command-center/T1_COMMAND_CENTER_BURNIN_TRUTH_CONTRACT.md). Read it to understand why a
