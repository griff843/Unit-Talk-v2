# CC_INTELLIGENCE_METRICS_REGISTER — ARCHIVED
...
[`docs/archive/command-center/CC_INTELLIGENCE_METRICS_REGISTER.md`](../../docs/archive/command-center/CC_INTELLIGENCE_METRICS_REGISTER.md). Read it to understand why a
