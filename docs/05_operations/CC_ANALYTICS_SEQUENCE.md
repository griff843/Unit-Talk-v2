# CC_ANALYTICS_SEQUENCE — ARCHIVED
...
[`docs/archive/command-center/CC_ANALYTICS_SEQUENCE.md`](../../docs/archive/command-center/CC_ANALYTICS_SEQUENCE.md). Read it to understand why a
