# DECISION_WORKSPACE_MVP — ARCHIVED
...
[`docs/archive/command-center/DECISION_WORKSPACE_MVP.md`](../../docs/archive/command-center/DECISION_WORKSPACE_MVP.md). Read it to understand why a
