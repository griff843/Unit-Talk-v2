# RESEARCH_WORKSPACE_MVP — ARCHIVED
...
[`docs/archive/command-center/RESEARCH_WORKSPACE_MVP.md`](../../docs/archive/command-center/RESEARCH_WORKSPACE_MVP.md). Read it to understand why a
