# Mission Plan — history archive, September 2026

**Read on demand, never at session start.** This file holds the chronological reconciliation
narrative that `plan.md` accumulated between 2026-09-05 and 2026-09-14, moved here verbatim when
`plan.md` was rebuilt as a compact startup document under UTV2-1921.

**This archive is not current state and carries no authority.** Every SHA, run id, PR state,
measurement and "executable now" claim below was true at the moment it was written and is stale by
construction. Current state is [`plan.md`](plan.md), reconciled against live GitHub, runtime and
database evidence; canonical contracts indexed in [`spec.md`](spec.md) remain controlling for their
governed domains.

Generalisable operating lessons were not moved here — they live in
[`plan-lessons.md`](plan-lessons.md), and are deliberately not duplicated in this file.

Measured evidence that already has a canonical home is cited from `plan.md` by pointer rather than
repeated: production acceptance in `docs/05_operations/PRODUCTION_ACCEPTANCE_2026-09-14.md`, the
readiness measurement in `docs/05_operations/READINESS_MEASUREMENT_2026-09-14.md`, reference-data
coverage in `docs/05_operations/REFERENCE_DATA_AUDIT_2026-09-13.md`.

---

## Contents

- [Chronological reconciliation passes (seventh, eighth, ninth)](#chronological-reconciliation-passes)
- [Milestone 1 — the completion record](#milestone-1--the-completion-record)
- [Reconciled current truth, 2026-09-12](#reconciled-current-truth-2026-09-12)
- [Execution waves, as written 2026-09-14](#execution-waves-as-written-2026-09-14)
- [Tracker-independence cutover — the detailed record](#tracker-independence-cutover--the-detailed-record)
- [Admissibility debt and the governed-gate defect diagnoses](#admissibility-debt-and-the-governed-gate-defect-diagnoses)
- [Superseded sequencing records](#superseded-sequencing-records)
- [Frozen pending PM architecture review — the full record](#frozen-pending-pm-architecture-review--the-full-record)
- [Milestone 2 as measured on 2026-09-12](#milestone-2-as-measured-on-2026-09-12)
- [Requires Griff, as written 2026-09-14](#requires-griff-as-written-2026-09-14)

---

## Chronological reconciliation passes

These three sections are the "ninth / eighth / seventh pass" narrative that made `plan.md`
unloadable. They are ordered newest first, exactly as they stood in `plan.md`.
...
## Milestone 1 — the completion record

Milestone 1 is complete; the summary that remains in `plan.md` states that. This is the full
evidence narrative as it was written on 2026-09-09.
...
## Reconciled current truth, 2026-09-12

Superseded in full. Retained because its boundary table and its three-layer settlement analysis are
the clearest written record of how the Smart Form to results journey was reasoned about.
...
## Execution waves, as written 2026-09-14

The live wave ordering is in `plan.md`. This is the full text, including the closed Wave 1 and the
two deployment decision packets, both of which were taken.
...
## Tracker-independence cutover — the detailed record

The cutover is still open; its live status and remaining exit conditions are in `plan.md`. This is
the full dependency map, change set, PR-review sequencing and measured friction log.
...
## Admissibility debt and the governed-gate defect diagnoses

The live count of inadmissible PRs is in `plan.md`. This is the full record, including the
review-packet scope-bleed diagnosis, the four-non-required-gates analysis, and the closeout
repeatability findings — several of which were corrected in place and are retained with their
corrections.
...
## Superseded sequencing records

Both were explicitly marked superseded in `plan.md` before this archive was created.
...
## Frozen pending PM architecture review — the full record

The live summary is in `plan.md` §8. This is the full text, including the enumerated list of what
is *not* ratified merely because it is implemented.
...
## Milestone 2 as measured on 2026-09-12

Superseded — `plan.md` §3 carries the current measurement. Retained for the condition-4 cohort
traps and the containment-is-binary analysis, both of which are still load-bearing and are cited in
abbreviated form from the live plan.
...
## Requires Griff, as written 2026-09-14

Superseded — `plan.md` §5 carries the current list. Retained because it records the three-step
edge-repair sequence (deploy, correct, verify) and the reasoning that made its ordering
load-bearing.
