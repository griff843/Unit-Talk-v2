...
```text
.github/workflows/ingestor-staleness-alert.yml |  57 +-
scripts/ingestor-alert-check.test.ts           | 387 +++++++++++++-
scripts/ingestor-alert-check.ts                | 714 +++++++++++++++++++------
3 files changed, 995 insertions(+), 163 deletions(-)
```
