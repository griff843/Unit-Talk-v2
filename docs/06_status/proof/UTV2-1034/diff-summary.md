...
- Writes output to `docs/06_status/proof/UTV2-1034/calibration-baseline-YYYYMMDD.md`
- Exits with warning if insufficient sample size (<20 usable rows)
- Reports ECE > 0.10 trigger for follow-on recalibration issue

### `docs/06_status/proof/UTV2-1034/calibration-baseline-20260524.md` (new)
...
Script infrastructure is ready; rerunning it will generate results once 20+ confidence-bearing settled picks accumulate.
