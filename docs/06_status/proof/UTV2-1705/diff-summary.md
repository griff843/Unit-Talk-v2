...
Verified implementation SHA: `a6173d9cdf15426459949d156ee2df359e6fa630`
...
- Retargeting the exact bound PR away from the manifest base now clears `pr_url` regardless of current lane status, preserves unrelated blockers while adding `pr-base-mismatch`, and prevents an explicit PR argument from reopening the wrong-base closeout path.
