...
MERGE_SHA: 5c2e34ce846b8005c34dacac2226a05c98c644d1
...
```text
Focused tests: 41 passed, 0 failed
...
| `pnpm exec tsx --test scripts/ops/lane-finalize.test.ts scripts/ops/lane-link-pr.test.ts` | PASS | 41 tests passed, 0 failed. |
