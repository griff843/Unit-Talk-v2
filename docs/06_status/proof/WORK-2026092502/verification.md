...
Head SHA: 3762b81d648a7790fdcd97045c338fc09d12c36e
result: pass
...
Measured at `3762b81d648a7790fdcd97045c338fc09d12c36e` in the lane worktree.
...
$ pnpm exec tsx scripts/ci/r-level-check.ts --issue WORK-2026092502 --base origin/main --head 3762b81d648a7790fdcd97045c338fc09d12c36e
Verdict: PASS
Changed files: 15
Rules matched: (none) — no R-level artifacts required for this diff
```

`pnpm test` was measured at `7d3ee96f0bfd8bbad7e45598caa92980eb762587`; `3762b81d648a7790fdcd97045c338fc09d12c36e` adds only
...
| M2 | fresh-archive result ignores `pruneHold` | red: pruneHold never prune-eligible (survived before `3762b81d648a7790fdcd97045c338fc09d12c36e`, which added the assertion) |
...
- [x] `pnpm exec tsx scripts/ci/r-level-check.ts --issue WORK-2026092502 --base origin/main --head 3762b81d648a7790fdcd97045c338fc09d12c36e`: PASS, 15 changed files, no R-level artifacts required
...
Execution SHA: 3762b81d648a7790fdcd97045c338fc09d12c36e

Execution anchor: `3762b81d648a7790fdcd97045c338fc09d12c36e` is the last implementation commit on this lane. The lane's
implementation is `7d3ee96f0bfd8bbad7e45598caa92980eb762587` and `3762b81d648a7790fdcd97045c338fc09d12c36e`, on top of the lane-start
...
### Re-anchor to `3762b81d648a7790fdcd97045c338fc09d12c36e`
