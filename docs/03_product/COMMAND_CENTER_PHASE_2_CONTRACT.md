# COMMAND_CENTER_PHASE_2_CONTRACT — ARCHIVED
...
[`docs/archive/command-center/COMMAND_CENTER_PHASE_2_CONTRACT.md`](../../docs/archive/command-center/COMMAND_CENTER_PHASE_2_CONTRACT.md). Read it to understand why a
