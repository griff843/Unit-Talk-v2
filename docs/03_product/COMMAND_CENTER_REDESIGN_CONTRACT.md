# COMMAND_CENTER_REDESIGN_CONTRACT — ARCHIVED
...
[`docs/archive/command-center/COMMAND_CENTER_REDESIGN_CONTRACT.md`](../../docs/archive/command-center/COMMAND_CENTER_REDESIGN_CONTRACT.md). Read it to understand why a
