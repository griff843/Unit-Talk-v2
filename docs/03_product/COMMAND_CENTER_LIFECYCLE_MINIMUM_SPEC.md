# COMMAND_CENTER_LIFECYCLE_MINIMUM_SPEC — ARCHIVED
...
[`docs/archive/command-center/COMMAND_CENTER_LIFECYCLE_MINIMUM_SPEC.md`](../../docs/archive/command-center/COMMAND_CENTER_LIFECYCLE_MINIMUM_SPEC.md). Read it to understand why a
