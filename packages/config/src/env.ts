...
export interface AppEnv {
  ...
  UNIT_TALK_INGESTOR_RESULTS_MAX_FETCH_MS?: string | undefined;
  UNIT_TALK_INGESTOR_OFFER_STALE_MINUTES?: string | undefined;
  UNIT_TALK_PROVIDER_OFFER_STAGING_MODE?: string | undefined;
  ...
  INGESTOR_ALERT_OFFERS_THRESHOLD_MINUTES?: string | undefined;
  INGESTOR_ALERT_RESULTS_THRESHOLD_MINUTES?: string | undefined;
  ...
  SYSTEM_PICK_SCANNER_DEGRADED_CONFIDENCE_FACTOR?: string | undefined;
...
export function loadEnvironment(rootDir = process.cwd()): AppEnv {
  ...
  const env: AppEnv = {
    ...
    UNIT_TALK_INGESTOR_RESULTS_MAX_FETCH_MS: optionalEnv('UNIT_TALK_INGESTOR_RESULTS_MAX_FETCH_MS', merged),
    UNIT_TALK_INGESTOR_OFFER_STALE_MINUTES: optionalEnv('UNIT_TALK_INGESTOR_OFFER_STALE_MINUTES', merged),
    UNIT_TALK_PROVIDER_OFFER_STAGING_MODE: optionalEnv('UNIT_TALK_PROVIDER_OFFER_STAGING_MODE', merged),
    UNIT_TALK_INGESTOR_DB_STATEMENT_TIMEOUT_MS: optionalEnv('UNIT_TALK_INGESTOR_DB_STATEMENT_TIMEOUT_MS', merged),
    UNIT_TALK_INGESTOR_DB_LOCK_TIMEOUT_MS: optionalEnv('UNIT_TALK_INGESTOR_DB_LOCK_TIMEOUT_MS', merged),
    UNIT_TALK_INGESTOR_DB_MAX_BATCH_SIZE: optionalEnv('UNIT_TALK_INGESTOR_DB_MAX_BATCH_SIZE', merged),
    UNIT_TALK_INGESTOR_DB_MERGE_CHUNK_SIZE: optionalEnv('UNIT_TALK_INGESTOR_DB_MERGE_CHUNK_SIZE', merged),
    UNIT_TALK_INGESTOR_DB_RETRY_MAX_ATTEMPTS: optionalEnv('UNIT_TALK_INGESTOR_DB_RETRY_MAX_ATTEMPTS', merged),
    UNIT_TALK_INGESTOR_DB_RETRY_BACKOFF_MS: optionalEnv('UNIT_TALK_INGESTOR_DB_RETRY_BACKOFF_MS', merged),
    UNIT_TALK_PROVIDER_PAYLOAD_ARCHIVE_MODE: optionalEnv('UNIT_TALK_PROVIDER_PAYLOAD_ARCHIVE_MODE', merged),
    UNIT_TALK_PROVIDER_PAYLOAD_ARCHIVE_DIR: optionalEnv('UNIT_TALK_PROVIDER_PAYLOAD_ARCHIVE_DIR', merged),
    INGESTOR_ALERT_OFFERS_THRESHOLD_MINUTES: optionalEnv('INGESTOR_ALERT_OFFERS_THRESHOLD_MINUTES', merged),
    INGESTOR_ALERT_RESULTS_THRESHOLD_MINUTES: optionalEnv('INGESTOR_ALERT_RESULTS_THRESHOLD_MINUTES', merged),
    ...
    SYSTEM_PICK_SCANNER_DEGRADED_CONFIDENCE_FACTOR: optionalEnv('SYSTEM_PICK_SCANNER_DEGRADED_CONFIDENCE_FACTOR', merged),
