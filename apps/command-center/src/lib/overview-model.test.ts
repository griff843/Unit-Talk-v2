...
const runtimeData: DashboardRuntimeData = {
  ...
  receipts: {
    ...
    failed: 1,
    simulated: 0,
    lastSentAt: '2026-05-01T11:58:55.000Z',
    lastFailedAt: '2026-05-01T11:57:00.000Z',
  },
  grading: {
    lastGradingRunAt: '2026-05-01T11:55:00.000Z',
    lastGradingRunStatus: 'success',
    lastPicksGraded: 3,
    lastFailed: 0,
    lastRecapPostAt: '2026-05-01T11:55:30.000Z',
    lastRecapChannel: 'discord:recap',
    runCount: 12,
  },
  observability: {
    failedRuns: 0,
    ...
    latestDistributionRunAt: '2026-05-01T11:59:00.000Z',
    latestIngestorRunAt: '2026-05-01T11:58:00.000Z',
    latestWorkerHeartbeatAt: '2026-05-01T11:59:20.000Z',
    alertConditions: [],
  },
  db: {
    disk: {
    ...
    connections: { used: 5, max: 100, waiting: 0 },
    locks: { waiting: 0 },
    longTransactions: { count: 0, maxAgeSeconds: 0 },
    slowQueries: { count: 0, maxAgeSeconds: 0 },
    wal: { sizeGiB: 0.1, estimatedGrowthGiBPerDay: 0.01, archiveMode: 'none', archiveConfigured: false },
