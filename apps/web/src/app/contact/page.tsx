...
export default function ContactPage() {
  return (
    <>
      ...
      <section className="mx-auto max-w-3xl space-y-6 px-4 pb-20 sm:px-6">
        <div className="ut-surface p-6 text-center">
          ...
          {/* TODO(discord-invite): wire the real Discord invite URL from site-config once created. */}
          <div className="mt-6">
        ...
        <div className="ut-surface p-6">
          ...
          <p className="ut-text-secondary mt-2 text-sm leading-relaxed">
            ...
            the{' '}
            <Link href="/faq" className="text-[var(--ut-accent)] hover:underline">
              FAQ page
            </Link>
            .
          </p>
        ...
        <div className="ut-surface p-6">
          ...
          {/* TODO(support-email): no approved public support email exists yet; add here once provisioned. */}
          <p className="ut-text-secondary mt-2 text-sm leading-relaxed">
