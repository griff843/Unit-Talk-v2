  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-3xl space-y-6 px-4 pb-16 sm:px-6">
        <div className="ut-surface ut-glow-border p-6">
          <p className="ut-eyebrow ut-eyebrow-gold">01 — The standard</p>
          <h2 className="mt-2 text-lg font-semibold">Transparency is part of the product</h2>
      ...
      <section className="border-t border-[var(--ut-border-subtle)] bg-[var(--ut-bg-surface)]">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          <SectionHeader eyebrow="Verified for Release" tone="gold" title="The transparency dashboard — coming soon" />
