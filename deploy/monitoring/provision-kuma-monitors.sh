...
# Uses Uptime Kuma v1 with uptime-kuma-api Python library (Socket.IO).
#
# Environment:
...
# ---------------------------------------------------------------------------
# 2. Ensure uptime-kuma-api Python library is available (in venv)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 4. Provision via Python + uptime-kuma-api (Socket.IO — v1 only)
# ---------------------------------------------------------------------------
