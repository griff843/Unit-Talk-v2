 ...
 * line and optionally posts a Discord alert.
 *
...
main().catch((error) => {
  console.error('[worker-alert] Failed to check worker heartbeat:', error instanceof Error ? error.message : String(error));
  process.exitCode = 1;
});
