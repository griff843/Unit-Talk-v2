...
/**
 * The proof files a NEW lane declares at start, for every tier.
 *
 * WORK-2026092608. These used to be tier-shaped (T1: evidence.json only; T2:
 * diff-summary.md + verification.md; T3: none), but the post-merge closeout
 * demands more than any one of those sets: truth-check P11 wants a diff
...
export function defaultProofPaths(issueId: string, _tier: LaneTier): string[] {
